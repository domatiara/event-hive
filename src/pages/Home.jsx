...
export default function Home() {
    return (
        <>
            <Navbar />
            <section className="bg-[url(./assets/images/hero-bg.png)] h-[596px] bg-cover w-[95%] mx-auto py-6 px-10 relative">
                <h1 className="text-white text-big-heading w-[30%] mx-auto text-center pt-32">MADE FOR THOSE WHO DO</h1>
                <form className="bg-navy-blue text-black w-[90%] mx-auto py-6 px-10 flex flex-row justify-between absolute -bottom-12 left-[5%]">
